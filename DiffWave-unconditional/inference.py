...
def generate(output_directory, num_samples, ckpt_path, ckpt_iter):
    ...
    generated_audio = sampling(
        net, (num_samples, 1, audio_length), diffusion_hyperparams
    )
    ...
    for i in range(num_samples):
        outfile = "{}_{}_{}k_{}.wav".format(
            wavenet_config["res_channels"], diffusion_config["T"], ckpt_iter // 1000, i
        )
        wavwrite(
...
if __name__ == "__main__":
    ...
    generate(**gen_config, ckpt_iter=args.ckpt_iter, num_samples=args.num_samples)
