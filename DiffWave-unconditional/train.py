...
def train(
    ...
    print("getting directories ready")
    ...
    print("mapping hyperparameters to gpu")
    ...
    print("loading data...")
    # load training data
    trainloader = load_Speech_commands(
        path=trainset_config["data_path"],
    ...
    while n_iter < n_iters + 1:
        for audio, _ in trainloader:
            ...
            if n_iter % iters_per_logging == 0 and rank == 0:
                print(
                    "iteration: {} \treduced loss: {} \tloss: {}".format(
                        n_iter, reduced_loss, loss.item()
                    )
                )
